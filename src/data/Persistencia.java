...
//        animales.add(new Carnivoro(5,250,especies.get(0), sectores.get(1), paisSeleccionado));
//        animales.add(new Carnivoro(2,180,especies.get(2), sectores.get(3), paisSeleccionado));
//        animales.add(new Herbivoro(3, 1020,especies.get(1), sectores.get(0), 170, paisSeleccionado));
//        animales.add(new Herbivoro(8, 3800,especies.get(3), sectores.get(2), 320, paisSeleccionado));
//    }
